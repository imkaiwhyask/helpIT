...
.article-card:hover { border-color:#0072bc; box-shadow: 0 4px 16px rgba(0,114,188,0.08); }

.article-header { display:flex; align-items:center; justify-content:space-between; }
.article-cat {
  font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.06em;
  color:#0072bc; background:#f0f7ff; padding:2px 8px; border-radius:4px;
}
.article-title { font-size:14px; font-weight:700; color:#0d1e30; line-height:1.4; }
.article-excerpt { font-size:12.5px; color:#64748b; line-height:1.5; flex:1;
...
.av-meta { display:flex; align-items:center; gap:8px; font-size:12.5px; color:#64748b; margin-bottom:20px; flex-wrap:wrap; }
.av-cat { font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.06em; color:#0072bc; background:#f0f7ff; padding:2px 8px; border-radius:4px; }
.av-tags { font-size:12px; color:#94a3b8; }
.av-content { font-size:14px; color:#1e293b; line-height:1.8; white-space:pre-wrap; }
