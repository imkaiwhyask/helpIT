...
.article-cat {
  ...
  color: #002d72; background: #fff0e6; padding:2px 8px; border-radius:2px;
}
...
.vis-internal { background: #e3f0ff; color: #002d72; }
...
.av-content :deep(blockquote) { border-left:3px solid #002d72; margin:12px 0; padding:8px 16px; background:#f5f7fa; color:rgba(0,0,0,0.54); }
