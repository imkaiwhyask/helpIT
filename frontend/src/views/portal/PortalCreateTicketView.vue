...
.urgency-selected.urgency-low {
  border-color: #2e7d32;
  border-width: 2px;
  background: #f1f8e9;
}
.urgency-selected.urgency-medium {
  border-color: #002d72;
  border-width: 2px;
  background: #fff0e6;
}
.urgency-selected.urgency-high {
  border-color: #f57f17;
  border-width: 2px;
  background: #fff8e1;
}
.urgency-selected.urgency-critical {
  border-color: #c62828;
  border-width: 2px;
  background: #ffebee;
}

.urgency-selected.urgency-low .urgency-label {
  color: #2e7d32;
}
.urgency-selected.urgency-medium .urgency-label {
  color: #002d72;
}
.urgency-selected.urgency-high .urgency-label {
  color: #f57f17;
}
.urgency-selected.urgency-critical .urgency-label {
  color: #c62828;
}
