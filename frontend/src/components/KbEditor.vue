...
.kb-toolbar button.active { background: rgba(0,45,114,0.12); color: #002d72; font-weight: 600; }
...
.kb-content :deep(.ProseMirror blockquote) {
  border-left: 3px solid #002d72; background: #f5f7fa;
...
.kb-content :deep(.ProseMirror a)        { color: #002d72; text-decoration: underline; }
